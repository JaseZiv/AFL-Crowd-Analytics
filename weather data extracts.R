...
get_rain <- function(stations, years) {
...
stations <- c(023090, 087014)

a <- get_rain(stations = c(023090, 087014), years = c(2018:2019))
...
get_temperature <- function(temp_stations, years) {
...
temperature <- get_temperature(temp_stations = c(023090, 089002), years = c(2018:2019))
